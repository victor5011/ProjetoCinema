...
namespace ProjetoCinema.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,ClienteId,CarrinhoCompraID,PedidoTotal,TotalItensPedido")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,ClienteId,CarrinhoCompraID,PedidoTotal,TotalItensPedido")] Pedido pedido)
        {
        ...
        public IActionResult PedidoFilmes(int? id)
        {
            ...
            PedidoFilmeViewModel pedidoFilmes = new PedidoFilmeViewModel()
            {
                Pedido = pedido,
                PedidoDetalhe = pedido.PedidoItens
            };
            return View(pedidoFilmes);
